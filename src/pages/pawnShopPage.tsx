    ...
    <div className="min-h-screen relative" style={{ background: 'linear-gradient(to bottom right, rgb(10, 35, 40), rgb(29, 126, 115), rgb(10, 35, 40))' }}>
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 py-6 sm:py-8 pt-24 sm:pt-32">
        ...
        <div className="text-center mb-8 sm:mb-12">
          <div className="backdrop-blur-xl inline-block px-6 sm:px-12 py-4 sm:py-6 rounded-2xl shadow-2xl border-2" style={{ background: 'linear-gradient(to right, rgba(0, 0, 0, 0.95), rgba(50, 50, 10, 0.9))', borderColor: '#FFD700', boxShadow: '0 0 30px rgba(255,215,0,0.5)' }}>
                  ...
                  <div className="md:w-2/3 w-full p-5 sm:p-8 flex flex-col justify-center">
                    <div className="space-y-4 sm:space-y-6">
                      ...
                      <div>
                        ...
                        <div className="h-1 w-16 sm:w-24 rounded-full" style={{ background: 'linear-gradient(to right, #FFD700, #B8860B)', boxShadow: '0 0 10px rgba(255,215,0,0.8)' }}></div>
                      </div>
